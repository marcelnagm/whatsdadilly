...
$live_timeline = $connection->get('statuses/user_timeline', array('screen_name' => $screenname, "count" => 2));
...
<div id="outer_box" >
    ...
    <div id="tabs">
        ...
        <div id="profile_img" style="text-align: left;  background:url('<?php echo $profile_banner->sizes->web->url; ?>') no-repeat center;"> <img src="<?php echo $profile_pic; ?>" width="200px" height="200px" style="margin-top: 59px;">
            ...
            <table width="100%">
                <tr> 
                    ...
                    <td width="40%" align=""><b><?php echo ucfirst($screenname); ?></b><br /><?php echo $user_info->location; ?></td>
                </tr>
                <tr>
                    <td width="60%" align="center">&nbsp;</td>
                    <td width="40%" align=""><?php echo $user_info->description; ?></td>
                </tr>
               <!-- <tr>
        ...
        <div id="update_counts" style="padding-top: 10px;">
            <table width="100%">
                <tr>
                    <td width="25%" align="center"><span class="count"><?php echo $user_info->followers_count; ?></span><br>Followers</td>
                    <td width="25%" align="center"><span class="count"><?php echo $user_info->friends_count; ?></span><br>Following</td>
                    <td width="25%" align="center"><span class="count"><?php echo $user_info->statuses_count; ?></span><br>Tweets</td>
                    <td width="25%" align="center"><span class="count"><?php echo $user_info->favourites_count; ?></span><br>Favorites</td>
                </tr>
            </table>
        </div>
   <div id="dmessage" style="display:none;">
        ...
        <div id="tw_reply" style="display:none;background:#ddd;">
        <table>
        <tr><td>&nbsp;</td></tr>
        <tr><th ><?php echo '@' . $screenname ?></th></tr>
        <tr><td >
            <textarea cols="50" id="rp_text" name="rp_text" value=""><?php echo '@' . $screenname ?></textarea></td></tr>
            <tr><td style="float: right;"><input type="button" name="rp_cancel" id="rp_cancel" value="Cancel"/>&nbsp;&nbsp;&nbsp;<input type="button" name="rp_send" id="rp_send" value="Tweet" /></td></tr><tr><td>&nbsp;</td></tr> </table>
        </div>
                ...
                foreach ($live_timeline as $k => $my_tweet) {
                    ...
                    if ($my_tweet->retweeted_status->id == '') {
                        ...
                        if ($my_tweet->current_user_retweet->id_str != '') {
                            ...
                            $RT_link = '<a href="#" class="big-link" onclick="pop_retweet(' . $k . ')"  data-animation="none"><i class="sm-rt"></i>Retweet</a>';
                        }
                        ...
                        echo '<div class="tweet-options">' . $RT_link . '&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="pfavorite(' . $k . ')"><i class="sm-fav"></i>Favorite</a>&nbsp;&nbsp;&nbsp;' . $media_flag . '&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="pdisplayreply(' . $k . ')"><i class="sm-reply"></i>
                             Reply</a>';
                        echo '</div>';
                        echo "<div class='tweet-retweeters' id='tweet-retweeters$k' style='display:none;'></div>";
                        echo $image_are;
